...
targets = {
    'josebobadilla', 'omarorduzs', 'jamesmateus_oficial', 'pablodibenedetto', 'carlosecastellanos71'
}
...
hashtags = {
    'networkmarketing', 'mexico', 'cdmx', 'colombian', 'french', 'model', 'mexicocity', 'cdmx', 'ciudaddemexico', 'mexicourbano', 'mexinstantes', 'mexicodf', 'df', 'instacdmx', 'cdmx'   
}
...
#Story watching and interacting    
...
#Le da follow a los usuarios de las cuentas que escogemos
    ...
    session.follow_user_followers(['josebobadilla', 'omarorduzs', 'jamesmateus_oficial', 'pablodibenedetto', 'carlosecastellanos71'], amount=50, randomize=True, interact=True, sleep_delay=60)
    
# Follow user based on hashtags (without liking the image)

    session.follow_by_tags(['networkmarketing', 'mexico', 'cdmx', 'colombian', 'french', 'model', 'mexicocity', 'cdmx', 'ciudaddemexico', 'mexicourbano', 'mexinstantes', 'mexicodf', 'df', 'instacdmx', 'cdmx'], amount=50, use_smart_hashtags=False, use_smart_location_hashtags=False, randomize=True, interact=True)
    
#Follow basado en la location    
    
    session.follow_by_locations(['567077758/mexico/', '669811849726034/cdmx/'], amount=50)

#Follow a los que le commentan a tus targets

    #session.follow_commenters(['josebobadilla', 'omarorduzs', 'jamesmateus_oficial', 'pablodibenedetto', 'carlosecastellanos71'], amount=3, daysold=15, max_pic = 5, interact=True)
...
#Like posts based on hashtags, the amount is per tag    
    session.like_by_tags(['networkmarketing', 'mexico', 'cdmx', 'colombian', 'french', 'model', 'mexicocity', 'cdmx', 'ciudaddemexico', 'mexicourbano', 'mexinstantes', 'mexicodf', 'df', 'instacdmx', 'cdmx'], amount=30, use_smart_hashtags=False, use_smart_location_hashtags=False, skip_top_posts=True, interact=True)

# Like a posts basado en su ubicacion
    session.like_by_locations(['567077758/mexico/', '669811849726034/cdmx/'], amount=40)
    

#Story activity

    session.story_by_tags(['networkmarketing', 'mexico', 'cdmx', 'colombian', 'french', 'model', 'mexicocity', 'cdmx', 'ciudaddemexico', 'mexicourbano', 'mexinstantes', 'mexicodf', 'df', 'instacdmx', 'cdmx'])
...
#Le da unfollow a todos, sin importar si te siguen o no, ni como los empezaste a seguir.    
    ...
    ###session.unfollow_users(amount=40, allFollowing=True, style="LIFO", unfollow_after=1*60*60, sleep_delay=300)
